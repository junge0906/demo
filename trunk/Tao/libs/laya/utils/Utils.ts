...
export class Utils {
    ...
    static getAngleOrPoints(point1: Vector2, point2: Vector2): number 
    {
        let vec:Vector2 =new Vector2(point2.x-point1.x,point2.y-point1.y);
      console.log("计算 角度",vec);
       return Math.acos(Vector2.dot(vec,new Vector2(0,1))/(Vector2.scalarLength(vec)));
    }
    /**
