...
export class RenderTexture extends BaseTexture {
     ...
     *从对象池获取临时渲染目标。
     */
    static createFromPool(width, height, format = RenderTextureFormat.R8G8B8, depthStencilFormat = RenderTextureDepthFormat.DEPTH_16, filterMode = FilterMode.Bilinear) {
        var tex;
