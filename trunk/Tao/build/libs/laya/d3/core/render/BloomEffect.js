...
export class BloomEffect extends PostProcessEffect {
    ...
    render(context) {
        ...
        for (var i = 0; i < iterations; i++) {
            ...
            var mipDownTexture = RenderTexture.createFromPool(tw, th, RenderTextureFormat.R8G8B8, RenderTextureDepthFormat.DEPTHSTENCIL_NONE, FilterMode.Bilinear);
            this._pyramid[downIndex] = mipDownTexture;
            if (i !== iterations - 1) {
                var mipUpTexture = RenderTexture.createFromPool(tw, th, RenderTextureFormat.R8G8B8, RenderTextureDepthFormat.DEPTHSTENCIL_NONE, FilterMode.Bilinear);
